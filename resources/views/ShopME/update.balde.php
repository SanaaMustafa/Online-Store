                ...
                <div class="col-md-4">
                    ...
                    <form action="{{ route('ShopME.update', $product->id) }}" method="POST" class="text-muted">
                      ...
                      <img src="{{$product->image}}">  
                       <center><input type="file" name="image">Change</center><br>
                        
                        <input type="text" name="shortdes" row="50" class="form-control" value="{{$product->shortdes}}"><br>
                         
                        <input type="text" name="longdes" row="50" class="form-control" value="{{$product->longdes}}"><br>
